    ...
    sealed class  PlayerModel : Model
    {
        ...
        public override void Initialize()
        {
            ...
            for (byte xCase = 0; xCase < this.cases.GetLength(0); xCase++)
            {
                ...
                {
                    this.cases[xCase, yCase] = new GameCase(this.MainGame, caseTexture);
        ...
        public bool IsFalseThan(Model model)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            if (this.InScaleAnimation)
            {
                ...
                this.Position = new Vector2(MainGame.Window.ClientBounds.Width / 2 - this.Size.X / 2, MainGame.Window.ClientBounds.Height - 1.3f * this.Size.Y);
            }
            else
            {
